...
`)
	...
	if strings.Contains(string(log), "releases/latest") || strings.Contains(string(log), "/releases/latest/download") || !strings.Contains(string(log), "/download/v0.5.2/install.sh") || strings.Contains(string(log), "/download/v0.5.2/attestations.jsonl") || !strings.Contains(string(log), "/download/v0.5.2/SHA256SUMS") || !strings.Contains(string(log), "/download/v0.5.2/codator-linux-amd64") {

...
`)
	...
	if strings.Contains(string(log), "releases/latest") || strings.Contains(string(log), "/releases/latest/download") || !strings.Contains(string(log), "/download/v0.6.3/install.sh") || strings.Contains(string(log), "/download/v0.6.3/attestations.jsonl") || !strings.Contains(string(log), "/download/v0.6.3/SHA256SUMS") || !strings.Contains(string(log), "/download/v0.6.3/codator-linux-amd64") {

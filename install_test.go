...
`)
	...
	if strings.Contains(string(log), "releases/latest") || strings.Contains(string(log), "/releases/latest/download") || !strings.Contains(string(log), "/download/v0.5.1/install.sh") || strings.Contains(string(log), "/download/v0.5.1/attestations.jsonl") || !strings.Contains(string(log), "/download/v0.5.1/SHA256SUMS") || !strings.Contains(string(log), "/download/v0.5.1/codator-linux-amd64") {
